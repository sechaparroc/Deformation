...
public class Splines {
	public static ArrayList<PVector> curve_cardinal;
	public static ArrayList<PVector> drawCardinalSpline( float tension, PVector k0, PVector k1, PVector k2, PVector k3, float e){
	...
	public static ArrayList<PVector> drawCurve(ArrayList<PVector> points, float tension, float e, boolean closed){
